...
class TikTokDownloader(BaseDownloader):
    ...
    def _get_common_options(self):
        ...
        options.update({
            ...
            'outtmpl': os.path.join(self.output_path, 'tiktok_%(uploader)s_%(id)s_%(timestamp)s.%(ext)s'),
    ...
    def download(self, url):
        ...
        try:
            ...
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                if not info:
                    return False, "無法獲取影片信息，請確認 URL 是否正確"
